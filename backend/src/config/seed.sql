...
VALUES 
    (
        ...
        'Se solicita retiro urgente ya que vecinos del sector siguen arrojando ramas de árboles secas, botellas y bolsas plásticas al costado del cierre perimetral del parque público.',
    ...
    (
        ...
        'Camión desconocido descargó sacos de cemento rotos, ladrillos y cerámicas en plena vereda impidiendo el libre tránsito de peatones y coches de guagua.',
    ...
    (
        ...
        'El camión recolector no ha pasado esta semana y el contenedor principal se encuentra colapsado de desperdicios orgánicos, generando mal olor en toda la cuadra comercial.',
    ...
    (
        ...
        'Restos de una remodelación particular fueron abandonados en la acera frente al 1050 de la Alameda. Obliga a la gente a bajar a la calzada vehicular con alto riesgo de atropello.',
    ...
    (
        ...
        'Locales comerciales del sector dejaron decenas de cajas de embalaje de gran tamaño desarmadas en el suelo, obstruyendo el punto verde de reciclaje comunitario.',
    ...
    (
        ...
        'Vecinos sacaron la basura fuera del horario correspondiente. Los animales rompieron los plásticos dejando restos de comida, envases y suciedad esparcida por el pasto de la plaza.',
    ...
    (
        ...
        'Durante la madrugada arrojaron un colchón de dos plazas y un sillón deteriorado en medio del bandejón de Av. Pajaritos, arruinando las áreas verdes del sector.',
    ...
    (
        ...
        'Foco de insalubridad detrás del paradero de transporte público. Hay decenas de botellas de alcohol quebradas y latas oxidadas, lo que representa un peligro inminente para los pasajeros.',
    ...
    (
        ...
        'Acumulación peligrosa de residuos tecnológicos que contienen materiales pesados. Hay dos pantallas TRT rotas, teclados viejos y gran cantidad de cableado enredado en la vereda.',
    ...
    (
        ...
        'Dejaron una pila de aproximadamente 8 neumáticos de camión en la orilla de la calzada. Acumulan agua estancada ideal para mosquitos y representan una alta carga de combustible ante incendios.',
